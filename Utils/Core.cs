...
namespace Plexus.Utils
{
    public class Core
    {
        ...
        /// <returns></returns>
        public static string GetAssemblyVersion(string assemblyName, int digit)
        {
            string lVersion = "";
        ...
        /// <summary>
        /// Get assembly date created.
        /// </summary>
        /// <param name="pg">Web page source: this.Page.</param>
        /// <param name="assemblyName">eg. INTEL.ITIL.DLL.</param>
        /// <returns>DateTime.</returns>
        public static DateTime GetAssemblyDateCreated(System.Web.UI.Page pg, string assemblyName)
        {
            DateTime ldt_Created = new DateTime(1, 1, 1);
            assemblyName = assemblyName.Trim().ToUpper();
            ...
            try
            {
                if (pg != null)
                {
                    System.IO.FileInfo lFileInfo = new System.IO.FileInfo(pg.Request.MapPath("bin\\" + assemblyName));
                    ldt_Created = lFileInfo.LastWriteTime;
                }
...
/**
 * Excel Reader
 * <seealso>http://www.codeproject.com/KB/office/Excel_DataReader.aspx</seealso>
 */
namespace Plexus.Utils.ExcelDataReader.Core
{
